---
name: add-event
description: Use when adding a new live sport event entry to this roball-website project (Sport/Events.md, Sport/Berichte.md, and data/grounds.json)
---
...
### Step 3 — Add Instagram embed to Berichte.md *(optional — only if Instagram URL was provided)*

Insert **after** line 7 (`Meine selbst verfassten Berichte.`), before the first existing `#` heading.
